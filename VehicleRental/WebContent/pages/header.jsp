<nav class="navbar navbar-light " id="header">
	...
	<ul class="nav nav-pills">
		<li class="nav-item"><a class="nav-link" href="./clients">Clients List</a></li>
		<li class="nav-item"><a class="nav-link" href="./cars">Vehicles List</a></li>
		<li class="nav-item"><a class="nav-link" href="./reservation">Book a car</a></li>
		<%
